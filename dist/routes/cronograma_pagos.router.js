...
const cronogramaPagosController = __importStar(require("../controllers/cronograma_pagos.controller"));
const CronogramaPagosRouter = (0, express_1.Router)();
...
exports.default = CronogramaPagosRouter;
