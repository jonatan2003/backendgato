...
const sunatService = __importStar(require("../services/sunat.services"));
...
const consultarDNI = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield sunatService.getDNIInfo(dni);
        res.json(data);
    }
    catch (error) {
...
const consultarRUC = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const data = yield sunatService.getRUCInfo(ruc);
        res.json(data);
    }
    catch (error) {
        if (axios_1.default.isAxiosError(error)) {
